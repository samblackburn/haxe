...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{4745537, 5442204, 5594513, 57476627, 76061764, 78945784, 87367608, 142301684, 221637784, 302979532, 312752480, 328878574, 359333139, 407283053, 437335495, 452737314, 501039929, 520590566, 537630174, 572311959, 616641298, 630156697, 746281503, 834174833, 863972113, 946786476, 1067353468, 1103412149, 1177754921, 1181037546, 1204816148, 1218336145, 1224901875, 1228056441, 1247875546, 1257164128, 1273207865, 1280845662, 1282943179, 1352786672, 1398464674, 1431819701, 1436822557, 1460447810, 1512997393, 1532710347, 1547539107, 1620824029, 1621420777, 1623148745, 1648581351, 1705629508, 1768617329, 1825849507, 1830310359, 1915412854, 1916009602, 1937159360, 1981972957, 2025055113, 2054707467, 2082663554, 2127021138};
		
		protected static string[] fields = new string[]{"__a", "map", "pop", "getEnumConstructs", "remove", "__previousException", "filter", "resize", "__nativeException", "methodName", "get_native", "iterator", "lastIndexOf", "hasNext", "message", "reverse", "insert", "length", "get_message", "native", "hello", "array", "contains", "value", "__nativeStack", "toString", "splice", "copy", "__skipStack", "join", "concat", "goodbye", "next", "enumConstructor", "push", "keyValueIterator", "current", "sort", "quicksort", "spliceVoid", "getEnumName", "createEnumIndex", "createEnum", "__ownStack", "posInfos", "concatNative", "className", "__unsafe_get", "__unsafe_set", "indexOf", "fileName", "toDynamic", "allEnums", "unwrap", "customParams", "__get", "__set", "__hx_deleteField", "lineNumber", "unshift", "enumParameters", "shift", "slice"};
